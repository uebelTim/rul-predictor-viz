    ...
    if break_algo == "Exponential vs Linear":
        ...
        with col_s:
            break_step = st.number_input(
                ...
                help="[Requires Simulation Re-run] How many days the window slides forward each iteration. Smaller steps offer higher precision at the cost of compute time."
            )
        with col_t:
